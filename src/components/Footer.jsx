    ...
    <footer className="footer">
      <div className="footer-main">
        ...
        <div className="footer-logo">
          ...
          <span className="footer-logo-text">VIRA</span>
        </div>

        {/* Tagline */}
        <p className="footer-tagline">
          Your brand needs to be seen, heard, and given love to
        </p>
        ...
        <div className="footer-socials">
          ...
          {/* TikTok */}
          <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="footer-social" aria-label="TikTok">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.54V6.77a4.85 4.85 0 01-1.01-.08z"/>
            </svg>
          </a>
          {/* Facebook */}
      ...
      <div className="footer-bottom">
        <p className="footer-copy">© 2025 VIRA Digital Agency. All rights reserved.</p>
        <p className="footer-made">Kigali, <span>Rwanda</span></p>
      </div>
    </footer>
  );
}
